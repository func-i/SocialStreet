class User < ActiveRecord::Base
  ...
  def post_to_facebook_wall(args = {})
    Resque.enqueue_in(15.minutes, Jobs::Facebook::PostToFbWall, self.id, args) if facebook_user && facebook_user.permissions.include?(:publish_stream) && !args[:message].blank?
  end
